...
public class VoyaControllerImplTest {
    ...
    public void testGetResponse() {
        ...
        VoyaRequestImpl req1 = new VoyaRequestImpl(0,0,VoyaRequestType.LAUNCH_REQUEST, "en-US", null, new GregorianCalendar(), new GregorianCalendar(), 0, false);
        VoyaRequestImpl req2 = new VoyaRequestImpl(0, 1111, VoyaRequestType.INTENT_REQUEST, "en-US", VoyaIntentType.SUMMARY, new GregorianCalendar(), new GregorianCalendar(), 0, false);
        VoyaRequestImpl req3 = new VoyaRequestImpl(1, 1111, VoyaRequestType.INTENT_REQUEST, "en-US", VoyaIntentType.SUMMARY, new GregorianCalendar(), new GregorianCalendar(), 0, false);
        VoyaRequestImpl req4 = new VoyaRequestImpl(1, 1111, VoyaRequestType.INTENT_REQUEST, "en-US", VoyaIntentType.YES, new GregorianCalendar(), new GregorianCalendar(), 0, false);
